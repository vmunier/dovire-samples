...
//is it an easy way to get compiler-generated companion object in annottees ?
@Record
case class Street(street: String, hno: Int)
{
  //is it possible to get classMeta without hardcoded class name nor macro ?
  //def printMeta = println(meta+' '+Street.classMeta)
}
object Street
